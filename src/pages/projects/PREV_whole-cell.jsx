...
import wholecelIImg1 from '../assets/imgs/projects/wholecell/Social Media.jpg';
import wholecelIImg2 from '../assets/imgs/projects/wholecell/LOGO.jpg';
import wholecelIImg3 from '../assets/imgs/projects/wholecell/WEBSITE.jpg';
import wholecelIImg4 from '../assets/imgs/projects/wholecell/01.jpg';
import wholecelIImg5 from '../assets/imgs/projects/wholecell/02.jpg';
				...
				<div className={styles.project_details_first_section}>
					...
					>
						<h1 className="heading text-animation">
							<span>Whole cell accessories</span>
						</h1>
					...
					<div className={styles.project_banner} id="banner_img">
						...
						<div className="cover-img-div">
							<Image src={wholeCellBanner} alt="baad me" />
						</div>
					</div>
				</div>
				<div className={styles.portfolio_images}>
					<div className={styles.portfolio_image}>
						<Image alt="baad me" src={wholecelIImg1} />
					</div>

					<div className={styles.portfolio_image}>
						<Image alt="baad me" src={wholecelIImg2} />
					</div>

					<div className={styles.portfolio_image}>
						<Image alt="baad me" src={wholecelIImg3} />
					</div>

					<div className={styles.portfolio_image}>
						<div className={styles.portfolio_half}>
							<Image alt="baad me" src={wholecelIImg4} />
						</div>
						<div className={styles.portfolio_half}>
							<Image alt="baad me" src={wholecelIImg5} />
						</div>
					</div>
				</div>
			</div>
