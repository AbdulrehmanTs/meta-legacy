...
const Banner = ({
	bannerContent: { heading, subHeading, btn1, btn2 },
	bottomNavigators,
}) => {
	...
	useEffect(() => {
		...
		tl.to('.firstLayer', { y: '-100%', duration: 1, ease: 'linear' })
			.to('.banner h1 > span', { y: 0, duration: 0.5 })
			.to('.banner h4 > span', { y: 0, duration: 0.5 })
			.to(['.banner .btn', 'nav ul li'], { opacity: 1, stagger: 0.1 })
		...
		<section className=" banner">
			...
			<div className="container">
				...
				<h4 className="mb1  mt1">
					<span>
						{subHeading[0]}{' '}
						<span className="colored"> {subHeading[1]} </span>{' '}
						{subHeading[2]}{' '}
						<span className="colored"> {subHeading[3]} </span>
					</span>
				</h4>
